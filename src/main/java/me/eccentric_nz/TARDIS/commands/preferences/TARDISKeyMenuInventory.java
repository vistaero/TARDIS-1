...
public class TARDISKeyMenuInventory {
    ...
    private ItemStack[] getItemStack() {
        ...
        ItemStack[] stack = {brass, plain, spade, silver, seal, variant, s_plain, clara, perception, null, susan, null, era, null, sally, null, bromley, null, null, null, null, null, info, null, null, null, close};
        return stack;
    }
